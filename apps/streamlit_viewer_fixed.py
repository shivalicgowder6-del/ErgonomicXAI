"""
Fixed Streamlit app for ergonomic risk assessment with fallback pose extraction
"""
...
from src.pose_extraction_fallback import PoseExtractor
...
st.markdown("Upload an image or select from existing images to analyze ergonomic risks.")
...
st.markdown("""
### 🔬 About ErgonomicXAI
This tool uses computer vision and AI to assess ergonomic risks in workplace images. 
It provides REBA (Rapid Entire Body Assessment) scores and actionable recommendations 
to improve workplace safety and reduce injury risk.

**Features:**
- 🎯 Real-time pose analysis
- 📊 REBA risk scoring
- 🤖 AI-powered explanations
- 💡 Actionable ergonomic advice
